...
// Small 9:16 thumbnail of how a frame looks: its background + the centered logo
// (inverted logos are flipped), so the list mirrors the actual composited output.
const PREVIEW_H = 44;
const PREVIEW_W = Math.round((PREVIEW_H * 9) / 16);

const FramePreview: React.FC<{ frame: Frame; logoSrc: string; logoSizePct: number }> = ({
  frame,
  logoSrc,
  logoSizePct,
}) => {
